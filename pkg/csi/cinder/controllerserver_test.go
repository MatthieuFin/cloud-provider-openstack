...
func genVolumeListExpectedResult() *csi.ListVolumesResponse {
	expectedRes := csi.ListVolumesResponse{}
	return &expectedRes
}
...
type ListVolumeTestCloudMock struct {
	cloudVolumeSet map[*openstack.OpenStackMock]ListVolumeTestOSMock
}
type ListVolumesTest struct {
	//volumeSet     *ListVolumeTestCloudMock
